    ...
    >
      <div class="flex items-center gap-1 py-1">
        <template v-if="node.resource.isFolder">
          <div class="w-100 toc-item-wrapper">
            <div>
              <OcButton
                appearance="raw"
                class="p-1 w-full justify-start text-left"
            ...
            <div class="flex nowrap gap-1 items-center">
          ...
          <div class="w-100 toc-item-wrapper">
            <div>
              <OcButton
                appearance="raw"
                class="p-1 w-full justify-start text-left"
                :class="{ 'font-semibold': node.resource.id === documentId }"
      ...
      <div v-if="!node.collapsed && node.children?.length" class="ml-4">
