<template>
  <ul class="ext:m-0 ext:flex ext:list-none ext:flex-col ext:gap-3 ext:p-0" @mouseleave="hovered = null">
    <li
...
const { aggregation, formatKey = undefined, selectable = false } = defineProps<{
